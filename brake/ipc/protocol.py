...
class Command(str, Enum):
    ...
    SET_RECOVERY_SETTINGS = "SET_RECOVERY_SETTINGS"
    LOCKOUT_RECOVERY = "LOCKOUT_RECOVERY"
    CLEAR_EXPIRED_LOCKOUT = "CLEAR_EXPIRED_LOCKOUT"
    CANCEL_RECOVERY_UNLOCK = "CANCEL_RECOVERY_UNLOCK"
    SET_SHUTDOWN_AFTER_LOCKOUT = "SET_SHUTDOWN_AFTER_LOCKOUT"
