...
This file is run directly (`pythonw.exe brake\\\boot.py`) by the Run key,
...
# Make `import brake` work when invoked by absolute path from HKCU\...\Run.
_REPO_ROOT = Path(__file__).resolve().parent.parent
if str(_REPO_ROOT) not in sys.path:
    sys.path.insert(0, str(_REPO_ROOT))

from brake.lockout.recovery import spawn_resume_lockout_if_needed  # noqa: E402
