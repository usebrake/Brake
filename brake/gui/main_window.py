...
from brake.branding import APP_NAME, APP_TAGLINE
from brake.gui.assets import _faded, brake_pixmap  # type: ignore[attr-defined]
from brake.gui.commitment_dialog import CommitmentDialog
...
class MainWindow(QMainWindow):
    ...
    def _on_test_lockout(self) -> None:
        subprocess.Popen(
            [sys.executable, "-m", "brake.lockout",
