"""LockItUpWatchdog — restarts LockItUpService if the SCM reports it stopped.
...
WATCHDOG_NAME = "LockItUpWatchdog"
TARGET_NAME = "LockItUpService"
...
if _PYWIN32_OK:
    class LockItUpWatchdog(win32serviceutil.ServiceFramework):
    ...
    LockItUpWatchdog = None  # type: ignore[assignment]
