...
from lockitup.detectors.anime_nsfw import anime_model_status, download_model, model_dir
from lockitup.gui.controller import Controller
from lockitup.lockout.recovery import spawn_resume_lockout_if_needed
from lockitup.runtime import lockout_command
from lockitup.state import State
from lockitup.state.crypto import hash_password
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="lockitup.desktop_bridge")
